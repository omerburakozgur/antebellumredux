NDefines = {
	...
	NDiplomacy = {
		...
		AE_SAME_CULTURE = 0.33,
		AE_SAME_CULTURE_GROUP = 0.2,
		AE_INFIDEL_CONQUEST = 0.2, 		-- different religion group conquered same religion province
		AE_SAME_RELIGION = 0.33,
		AE_SAME_RELIGION_GROUP = 0.0,
		AE_DIFFERENT_RELIGION = -0.33,
		AE_HRE_INTERNAL = 0.33,
	...
	NCountry = {
		...
		ABDICATE_RULING_LENGTH_THRESHOLD = 4,
		...
		NEW_HEIR_LEGITIMACY_THRESHOLD = 50,
		...
		NAT_FOCUS_YEARS = -1,							-- years before you can change focus again
	...
	NMilitary = {
		...
		DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 1.6,		-- Amount of warscore per month since attacker/defender started getting the bonus for completing war goal
